    ...
    {//Robert Young
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                double gradeScore = Convert.ToDouble(assignmentScore);
            ...
            //double sum = 0
            double average = sum / assignmentScore.Count;

            Console.WriteLine($"Your average for the {assignmentScore.Count} grades is {average.ToString("N3")}");
